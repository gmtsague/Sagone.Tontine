...
{
    public static partial class MeetSortieCaisseMapper
    {
        public static MeetSortieCaisseDto AdaptToDto(this MeetSortieCaisse p1)
        {
            return p1 == null ? null : new MeetSortieCaisseDto()
            {
                ...
                ListeMandataires = p1.ListeMandataires,
        ...
        public static MeetSortieCaisseDto AdaptTo(this MeetSortieCaisse p2, MeetSortieCaisseDto p3)
        {
            if (p2 == null)
            {
                return null;
            }
            MeetSortieCaisseDto result = p3 ?? new MeetSortieCaisseDto();
            ...
            result.ListeMandataires = p2.ListeMandataires;
            ...
            result.Seance = funcMain13(p2.Seance, result.Seance);
            return result;
        ...
        private static MeetSeanceDto funcMain13(MeetSeance p28, MeetSeanceDto p29)
        {
            if (p28 == null)
            {
                return null;
            }
            MeetSeanceDto result = p29 ?? new MeetSeanceDto();
            
            result.SeanceId = p28.SeanceId;
            result.CreateUid = p28.CreateUid;
            result.UpdateUid = p28.UpdateUid;
            result.AnneeId = p28.AnneeId;
            result.DivisionId = p28.DivisionId;
            result.EtabId = p28.EtabId;
            result.AntenneId = p28.AntenneId;
            result.Opendate = p28.Opendate;
            result.Closedate = p28.Closedate;
            result.TotalEntrees = p28.TotalEntrees;
            result.TotalSorties = p28.TotalSorties;
            result.Depensecollation = p28.Depensecollation;
            result.Compterendu = p28.Compterendu;
            result.Status = p28.Status;
            return result;
