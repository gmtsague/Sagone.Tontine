...
{
    public static partial class MeetMaxAllowSignatureMapper
    {
        public static MeetMaxAllowSignatureDto AdaptToDto(this MeetMaxAllowSignature p1)
        {
            return p1 == null ? null : new MeetMaxAllowSignatureDto()
            {
                Id = p1.Id,
        ...
        public static MeetMaxAllowSignatureDto AdaptTo(this MeetMaxAllowSignature p2, MeetMaxAllowSignatureDto p3)
        {
            if (p2 == null)
            {
                return null;
            }
            MeetMaxAllowSignatureDto result = p3 ?? new MeetMaxAllowSignatureDto();
