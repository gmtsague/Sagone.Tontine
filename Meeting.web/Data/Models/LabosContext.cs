...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CoreBankaccount>(entity =>
        {
            ...
            entity.Property(e => e.IsDefault).HasComment("is_default");
            entity.Property(e => e.UpdateAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasComment("Update_at");
            entity.Property(e => e.UpdateUid).HasComment("update_uid");
        ...
        modelBuilder.Entity<CoreCountry>(entity =>
        {
            ...
            entity.Property(e => e.Libelle).HasComment("Nom du pays").HasColumnType("jsonb");
        ...
        modelBuilder.Entity<MeetEngagement>(entity =>
        {
            ...
            entity.Property(e => e.ToPay).HasComment("Montant total a payer au cours d'un exercice");
            entity.Property(e => e.NbReqSeances).HasComment("Nombre de seances/versements requis pour solder l'engagement.");
            entity.Property(e => e.CustomAmount).HasComment("Montant personnalise a cotiser a chaque periode");
            entity.Property(e => e.UpdateAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasComment("Update_at");
            entity.Property(e => e.UpdateUid).HasComment("update_uid");
        ...
        modelBuilder.Entity<MeetPresence>(entity =>
        {
            ...
            entity.Property(e => e.VerseCash).HasComment("Verse_cash");
            entity.Property(e => e.VerseTransfert).HasComment("Verse_transfert");
        ...
        modelBuilder.Entity<MeetRubrique>(entity =>
        {
            ...
            entity.Property(e => e.TyperubId).HasComment("Identifiant du type d'evenement");
            entity.Property(e => e.AllowCustomAmount).HasComment("Autoriser un membre a definir un montant a cotiser different de celui defini par defaut");
            entity.Property(e => e.TopayEachPeriode).HasComment("Une rubrique de cette categorie doit faire l'objet d''un versement du montant total defini a chaque periode (mois, semaine, etc) d'un exercice.");
            entity.Property(e => e.Numordre).HasDefaultValueSql("1")
        ...
        modelBuilder.Entity<MeetSortieCaisse>(entity =>
        {
            ...
            entity.Property(e => e.BenefPrincipal).HasComment("Benef_principal");
            entity.Property(e => e.Montantpercu).HasComment("Montant percu par le beneficiaire de l'evenement");
            entity.Property(e => e.Note).HasComment("Observation generale concernant le deroulement de l'evenement");
            entity.Property(e => e.SeanceId).HasComment("Seance_id");
            entity.Property(e => e.UpdateAt)
    ...
    public DbSet<Meeting.Web.Dto.PresenceDto> PresenceDto { get; set; } = default!;

    /*public DbSet<Meeting.Web.Dto.AntenneDto> AntenneDto { get; set; } = default!;

    public DbSet<Meeting.Web.Dto.PosteDto> PosteDto { get; set; } = default!;

    public DbSet<Meeting.Web.Dto.InscriptionDto> InscriptionDto { get; set; } = default!;
	*/
}
